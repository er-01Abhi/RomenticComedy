...
const Dashboard = ({
     ...
     */
    const onLoadMore = () => {
        if (currentPage < totalPages && !showSearchBar) {
    ...
    /**
     * @description Method used for handle back button
     */
    ...
    return (
        <View
            ...
            }, !scrollUp && { backgroundColor: Colors.black }]}>
            <CustomHeader
                showSearch={true}
